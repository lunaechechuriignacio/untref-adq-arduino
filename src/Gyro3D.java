...
public class Gyro3D {
	...
	public Gyro3D(Canvas3D canvas) {
		...
		ColorCube cone = new ColorCube(0.1f);
	...
	public void rotate(DatoAcelerometro acelerometro) {

		// this.transform = new Transform3D();
		Transform3D temp = new Transform3D();

		temp.rotX(Math.toRadians(acelerometro.gx / 25000));
		this.transform.mul(temp);

		temp.rotZ(Math.toRadians(acelerometro.gy / 25000));
		this.transform.mul(temp);

		temp.rotY(Math.toRadians(acelerometro.gz / 25000));
		this.transform.mul(temp);
